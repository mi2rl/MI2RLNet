...
from .models.cascade_1st.model_ACE_CNet_1st import *
from .models.cascade_2nd.model_1.model_ACE_CNet_2nd import *

smooth = 1.


def ACE_CNet_1st(input_shape, num_labels, axis=-1, base_filter=32, depth_size=4, se_res_block=True, se_ratio=16,
